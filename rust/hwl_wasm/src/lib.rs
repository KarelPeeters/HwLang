use hwl_common::back::lower_cpp::lower_to_cpp;
use hwl_common::back::lower_verilog::lower_to_verilog;
use hwl_common::diagnostic::{DiagResult, Diagnostics, diags_to_string};
use hwl_common::pos::Spanned;
use hwl_common::source::{FileId, SourceDatabase};
use hwl_common::util::{NON_ZERO_USIZE_ONE, ResultExt};
