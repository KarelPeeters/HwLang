...
use crate::consts::{
    ...
    COLOR_SPACER_SELECTED_BG, COLOR_STATUS_TEXT, COLOR_TEXT_PRIMARY, COLOR_TEXT_STRONG, COLOR_WAVE_EVEN_BG,
    COLOR_WAVE_EXPANDED_BG, COLOR_WAVE_ODD_BG, COLOR_WAVE_SUBSECTION_BG, CURSOR_STATS_COLUMN_WIDTH,
    DEFAULT_ROW_LABEL_WIDTH, MAX_PIXELS_PER_TIME, MIN_PIXELS_PER_TIME, MIN_ROW_LABEL_WIDTH, ROW_HEIGHT,
};
use crate::format::{WaveRadix, enum_tag_width, format_value_for_type_with_radix};
use crate::panels::{draw_hierarchy, draw_signal_panel_row, filtered_signal_ids, filtered_signal_ids_for_module};
use crate::render::{WaveDisplayOptions, WaveRenderMode, draw_waveform};
use crate::rows::{
...
use crate::time::{
    ...
    draw_time_view_range, draw_zoom_selection, edge_counts, time_from_pointer, wave_content_width, zoom_to_selection,
};
